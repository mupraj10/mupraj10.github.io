...
const Projects = () => {
  ...
  const projectStyle = "dt w-100 link b--black-10 pb2 mt3 dim ";
  return (
    <section className="vh-8 dt w-100 cf pv6-ns pv3 pl3 overflow-container">
      <div className="f3 fl pv4 ttu tracked fs-normal mt0 mb0">Projects</div>
      ...
      <section className="w-100 pa3-m pa4-l">
        {projects.map(project => {
          return (
            ...
            >
              <span className="w-25-l f5 fw5 ttu tracked black fl">
                {project.name}
              </span>
