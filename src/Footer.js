...
const Footer = () => {
  ...
  return (
    <footer className="cf tc mt2">
    <a className="link hover-dark-gray near-black dib h2 w2 mr3" href='mailto: mupraj10@gmail.com' title="Gmail">
    <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fillRule="evenodd" clipRule="evenodd" strokeLinejoin="round" strokeMiterlimit="1.414"><path d="M24 4.5v15c0 .85-.65 1.5-1.5 1.5H21V7.387l-9 6.463-9-6.463V21H1.5C.649 21 0 20.35 0 19.5v-15c0-.425.162-.8.431-1.068C.7 3.16 1.076 3 1.5 3H2l10 7.25L22 3h.5c.425 0 .8.162 1.069.432.27.268.431.643.431 1.068z"/></svg>
  </a>

    <a className="link near-black hover-dark-gray dib h2 w2 mr3" href="https://github.com/mupraj10" title="GitHub">
  ...
  <a className="link hover-dark-gray near-black dib h2 w2 mr3" href="https://linkedin.com/in/maggy-prajapati" title="LinkedIn">
    <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fillRule="evenodd" clipRule="evenodd" strokeLinejoin="round" strokeMiterlimit="1.414"> <path d="M13.632 13.635h-2.37V9.922c0-.886-.018-2.025-1.234-2.025-1.235 0-1.424.964-1.424 1.96v3.778h-2.37V6H8.51V7.04h.03c.318-.6 1.092-1.233 2.247-1.233 2.4 0 2.845 1.58 2.845 3.637v4.188zM3.558 4.955c-.762 0-1.376-.617-1.376-1.377 0-.758.614-1.375 1.376-1.375.76 0 1.376.617 1.376 1.375 0 .76-.617 1.377-1.376 1.377zm1.188 8.68H2.37V6h2.376v7.635zM14.816 0H1.18C.528 0 0 .516 0 1.153v13.694C0 15.484.528 16 1.18 16h13.635c.652 0 1.185-.516 1.185-1.153V1.153C16 .516 15.467 0 14.815 0z" fillRule="nonzero"/></svg>
  </a>
  <a className="link hover-dark-gray near-black dib h2 w2 mr3" href="https://medium.com/@mupraj10" title="Medium">
  ...
  <a className="link hover-dark-gray near-black dib h2 w2 mr3" href="https://instagram.com/maggyidk" title="Instagram">
...
<a className="link hover-dark-gray near-black dib h2 w2 mr3" href="https://twitter.com/maggyidk" title="Twitter">
...
export default Footer;
 ...
 // {links.map(link => <a key={link.name} classNameName="link black-80 hover-yellow dib mr3 f4" to={link.link}> {link.name} </a>)}

//  <a className="link hover-dark-gray near-black dib h2 w2 mr3" href="#" title="Stack Overflow">
