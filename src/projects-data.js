...
},
{
    ...
    completed: false,
    picture: "/",
    blurb:"A native application that uses geolocation to find Ice Cream locations near you.",
    info: "It gives you a list of approximately 30 places that are relatively close to you. When selecting one of the locations, the information provided will be whether the location is currently open or closed, address, phone number and a map with its location marked in screen.",
